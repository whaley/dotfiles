...
if __name__ == "__main__":
  ...
  if workplace_window_id:
    ...
    subprocess.run([AEROSPACE, "move-node-to-workspace", "--window-id", str(workplace_window_id), active_workspace_name, "--fail-if-noop",])
  else:
    subprocess.run(["open","/Users/whaley/Applications/Chrome Apps.localized/Workplace.app"])
